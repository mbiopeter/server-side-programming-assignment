        ...
        <div class="gallery-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <?php
              ...
              $gallexc = mysqli_query($connection,$gallary);
            ?>
            <?php while($row = mysqli_fetch_array($gallexc)): ?>
              <div class="swiper-slide"><a class="gallery-lightbox" href="assets/img/gallery/<?php echo $row['image'] ?>"><img src="assets/img/gallery//<?php echo $row['image'] ?>" class="img-fluid" alt=""></a></div>
            <?php endwhile; ?>
